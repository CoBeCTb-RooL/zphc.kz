<?php 
class FakecheckController extends MainController{
	...
	function index()
	{
		...
		$CONTENT->setTitle('Проверка подлинности');
		
		$_GLOBALS['activeMenu'][34] = true;
		$_GLOBALS['activeMenu'][49] = true;
		...
		$MODEL['crumbs'][] = 'Проверка подлинности';
		$MODEL['crumbs'] = $MODEL['crumbs'];
		
		Core::renderView('fakecheck/index.php', $MODEL);
	}
