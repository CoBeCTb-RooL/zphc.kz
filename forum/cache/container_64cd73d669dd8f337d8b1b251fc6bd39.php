...
class phpbb_cache_container extends Symfony\Component\DependencyInjection\ContainerBuilder
{
    ...
    protected function getDbal_Conn_DriverService()
    {
        ...
        $instance->sql_connect('localhost', 'p-145_forum_user', 'ajP356j~Fln5!a32', 'p-1456_zphc_forum', '', false, false);
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'dbal.dbuser' => 'p-145_forum_user',
            'dbal.dbpasswd' => 'ajP356j~Fln5!a32',
            'dbal.dbname' => 'p-1456_zphc_forum',
            'dbal.dbport' => '',
            'dbal.new_link' => false,
        );
    }
