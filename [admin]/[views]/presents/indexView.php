...
function itemsList()
{
	...
	$.ajax({
		url: '/admin/presents/itemsListAjax',
		data: OPTS,
...
{
	$.ajax({
		url: '/admin/presents/itemSwitchStatus',
		data: 'id='+id,
		dataType: 'json',
		beforeSend: function(){$.fancybox.showLoading()},
		success: function(data){
...
function itemDelete(id)
{
	...
	$(document).ready(function(){
		...
		<?php 
		if($_REQUEST['presentId'])
		{?>
		itemEdit(<?=$_REQUEST['presentId']?>);
		<?php 	
		}?>
	});
</script>
