...
<script>
var	OPTS = {}
OPTS.chosenUserId = <?=$_REQUEST['chosenUserId'] ? $_REQUEST['chosenUserId'] : '""'?>
...
function itemsList()
{
	...
	$.ajax({
		url: '/admin/orders/itemsListAjax',
		data: OPTS,
...
{
	$.ajax({
		url: '/admin/orders/itemSwitchStatus',
		data: 'id='+id,
		dataType: 'json',
		beforeSend: function(){$.fancybox.showLoading()},
		success: function(data){
...
<h1><i class="fa fa-list-alt"></i> Заказы</h1>
