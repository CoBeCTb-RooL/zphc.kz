...
<div id="optCartProductRowTmpl" style="display: none; ">
    <div class="item " id="cart-item-_ID_">
        <div class="kol title">
		<span class=" pic">
			<a href="/catalog/item/_URL_PIECE_" target="_blank" title="_NAME_" style="height: 40px;"><img src="/include/resize.slonne.php?img=../upload/images/_PHOTO_&amp;width=120" alt="_NAME_" ></a>
		</span>
