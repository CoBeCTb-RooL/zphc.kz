...
<h1><?=$item ? $item->name : 'Акция'?><span class="title-gray"> : <?=$item ? 'Редактирование' : 'Добавление'?></span></h1>

<form id="item-edit-form" enctype="multipart/form-data" method="post" action="/<?=ADMIN_URL_SIGN?>/actions/itemEditSubmit" target="frame81" onsubmit="itemEditSubmitStart(); " >
